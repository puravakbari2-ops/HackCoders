...
// Middle Ministries Batch:
// 1. MSME: 22 schemes
// 2. Agriculture and Farmers Welfare: 18 schemes
// 3. Textiles: 17 schemes
// 4. Culture: 13 schemes
// 5. Electronics and Information Technology: 13 schemes
// 6. Home Affairs: 12 schemes
// 7. Youth Affairs & Sports: 12 schemes
// 8. Defence: 10 schemes
// Total = 117 schemes
...
const msmeSchemes = [
    {
        ...
        tags: ["PM Vishwakarma", "Traditional Artisans", "Tool-kit Grant", "Collateral Free Loan"],
    ...
    },
    {
        ...
        tags: ["CGTMSE", "Collateral Free", "Bank Loan", "MSME Credit Guarantee"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PMEGP", "KVIC", "Margin Money Subsidy", "Bank Finance", "New Business"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SFURTI", "Traditional Cluster", "Artisans", "Common Facility Centre"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["MSE-CDP", "Industrial Cluster", "Testing Lab", "Infrastructure Grant"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["ASPIRE", "LBI", "Rural Incubation", "Agri-Business"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["ZED Certification", "Zero Defect", "Clean Energy", "Quality Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Lean Manufacturing", "5S", "Kaizen", "Productivity Subsidy"],
        ...
        eligibility: {
            ...
            maxAge: 70,
            gender: ["male", "female", "transgender"],
            income: ["2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["self-employed"]
        },
    ...
    },
    {
        ...
        tags: ["Digital MSME", "Cloud ERP", "Accounting Software", "IT Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Design Clinic", "Industrial Design", "NID", "Product Innovation"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["IPR Subsidy", "Patent Reimbursement", "Trademark", "GI Registration"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["ESDP", "Skill Training", "Youth Entrepreneurship", "Free Workshop"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PMS", "Trade Fair Subsidy", "GeM Stalls", "Packaging Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["IC Scheme", "Overseas Exhibitions", "Airfare Subsidy", "B2B Meetings"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Coir Board", "Coir Artisans", "Yarn Spinning", "Skill Stipend"],
        ...
        eligibility: {
            ...
            category: ["general", "sc", "st", "obc"],
            occupation: ["daily-wage-worker", "self-employed", "homemaker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["CITUS", "Coir Machinery", "Capital Subsidy", "Coir Board"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Mahila Coir", "Women Artisans", "75% Subsidy", "Motorized Ratt"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["homemaker", "daily-wage-worker", "self-employed"]
        },
        applyLink: "https://coirboard.gov.in/",
        baseMatchScore: 86
    },
    {
        ...
        tags: ["Honey Mission", "KVIC", "Bee Boxes", "Beekeeping", "Rural Livelihood"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["farmer", "unemployed", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Pottery Mission", "Electric Chaak", "Potters", "KVIC", "Pug Mill"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Agarbatti Mission", "Handmade Paper", "KVIC", "SHG Women"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NSSH", "SC/ST Hub", "25% Capital Subsidy", "Public Procurement"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["MSME Sambandh", "Public Procurement", "CPSE Tenders", "25% Mandatory"],
...
const agriSchemes = [
    {
        ...
        tags: ["PM-KMY", "Farmer Pension", "Old Age", "LIC", "Monthly 3000"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["PMFBY", "Crop Insurance", "Drought Relief", "Flood Cover", "Low Premium"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["RWBCIS", "Weather Insurance", "Rainfall Deficit", "Frost & Heatwave"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["SMAM", "Tractor Subsidy", "Farm Machinery", "Custom Hiring", "40-50% Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["SMSP", "Certified Seeds", "Seed Village", "Seed Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["Oil Palm", "NMEO-OP", "Viability Price", "Sapling Subsidy", "North East"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["Oilseeds", "Mustard", "Soybean", "Groundnut", "MSP Procurement"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["MIDH", "Polyhouse", "Cold Storage", "Horticulture Subsidy", "Fruit Orchard"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["NBHM", "Sweet Revolution", "Madhu Kranti", "Honey Testing"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["PKVY", "Organic Farming", "PGS India", "Bio Fertilizers", "DBT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["MOVCDNER", "North East", "Organic Exports", "FPO Brand"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["PDMC", "Drip Irrigation", "Sprinkler", "Water Saving", "55% Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["RAD", "Integrated Farming", "Crops plus Dairy", "Rainfed"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["Soil Health Card", "Soil Testing", "Fertilizer Recommendation", "Village Lab"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["farmer", "student", "self-employed"]
        },
    ...
    },
    {
        ...
        tags: ["Kisan Credit Card", "KCC", "Low Interest Loan", "Subvention 4%"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["ATMA", "Farmer Training", "Exposure Tours", "KVK Demonstrations"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["MKSP", "Women Farmers", "Krishi Sakhi", "Sustainable Agriculture"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["Kisan Call Centre", "1800-180-1551", "Kisan Suvidha", "Weather Advisory", "Mandi Prices"],
...
const textilesSchemes = [
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PM MITRA", "Textile Parks", "Plug & Play", "Mega Cluster", "5F Formula"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI Textiles", "MMF Apparel", "Technical Textiles", "Manufacturing Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["SAMARTH", "Textile Skilling", "Garmenting", "Stipend", "Job Guarantee"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["Technical Textiles", "Geotextiles", "Meditech", "Agrotech", "R&D Grant"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["ATUFS", "Capital Subsidy", "Weaving Looms", "Knitting", "Textile Modernization"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PowerTex", "Powerloom Subsidy", "Shuttleless Looms", "Solar Powerloom"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["Silk Samagra", "Sericulture", "Mulberry Silk", "Silk Cocoon", "Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NHDP", "Handloom Weavers", "Raw Material Subsidy", "Yarn Supply"],
    ...
    },
    {
        ...
        type: "central",
        category: "Banking, Financial Services & Insurance",
        tags: ["Weaver Insurance", "Life Cover", "Accidental Death", "Govt Subsidized"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["AHVY", "Handicrafts", "Artisans", "Skill Upgradation", "Dastkar"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Handicrafts Design", "NIFT Mentorship", "Artisan Workshops", "Prototype Grant"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["Jute-ICARE", "Golden Fibre", "Retting Tank", "Seed Subsidy", "Microbial Retting"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SITP", "Textile Parks", "Common Infrastructure", "Captive Power"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Kasturi Cotton", "Traceability", "Blockchain", "Premium Exports"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["HSS Looms", "90% Subsidy", "Pneumatic Looms", "Drudgery Reduction"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["IWDP", "Pashmina", "Sheep Breeders", "Wool Processing", "Himalayan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Silk Mark", "Handloom Mark", "Authenticity Label", "Consumer Protection"],
...
const cultureSchemes = [
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Artistes Pension", "Veteran Artists", "Monthly 6000", "Old Age Pension"],
    ...
    },
    {
        ...
        tags: ["Culture Fellowship", "Senior Fellowship", "Classical Music", "Dance", "Theatre"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["self-employed", "student", "salaried"]
        },
        applyLink: "https://indiaculture.gov.in/",
        baseMatchScore: 84
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Cultural Grants", "National Presence", "Auditorium", "Music Festivals"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Guru Shishya", "Repertory Grant", "Monthly Honorarium", "Classical Arts"],
    ...
    },
    {
        ...
        tags: ["Tagore Cultural Complexes", "Auditorium Grant", "Acoustics", "State Theatres"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Seva Bhoj", "Free Langar", "GST Reimbursement", "Charitable Institutions"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Mera Gaon Meri Dharohar", "Village Heritage", "Artisan Mapping", "GIS"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "farmer", "self-employed", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["ICH", "UNESCO Heritage", "Vedic Chanting", "Kumbh", "Folk Traditions"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["self-employed", "salaried", "student"]
        },
        applyLink: "https://indiaculture.gov.in/",
        baseMatchScore: 77
    },
    {
        ...
        tags: ["Festival of India", "Cultural Troupes", "International Tours", "Airfare"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Buddhist Culture", "Tibetan Monasteries", "Manuscripts", "Monk Education"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NCF", "Monument Adoption", "CSR Heritage", "Tax Exemption 100%"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Gandhi Peace Prize", "₹1 Crore Award", "Non-Violence", "President of India"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Manuscripts", "Palm Leaf Digitization", "Kriti Sampada", "Ancient Texts"],
...
const meitySchemes = [
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["SPECS", "Electronic Components", "25% Capital Subsidy", "Semiconductor"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["DLI", "Semiconductor Design", "EDA Tools", "Chip Startups", "50% Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["Silicon Fabs", "50% Fiscal Support", "Semiconductor Fab", "Make in India"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["Display Fabs", "AMOLED", "TFT LCD", "50% Support", "Display Manufacturing"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["OSAT", "ATMP", "Compound Semis", "Gallium Nitride", "Chip Packaging"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["TIDE 2.0", "Incubator Grants", "AI Startups", "IoT Grant", "Entrepreneurship"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["Cyber Swachhta", "Free Antivirus", "CERT-In", "Botnet Removal", "Malware Tool"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["Bhashini", "AI Translation", "Vernacular AI", "Voice Recognition", "Indian Languages"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "self-employed", "salaried"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["IndiaAI", "AI Compute", "GPU Cloud", "Datasets", "AI Fellowships"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["CHUNAUTI", "Tier 2 Startups", "Seed Grant 25 Lakh", "STPI Mentorship"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["FutureSkills", "NASSCOM", "Cloud/AI Courses", "50% Fee Subsidy", "Govt Certificate"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "salaried", "unemployed"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["PMGDISHA", "Digital Literacy", "Rural Computer", "Free Certificate", "CSC"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["farmer", "daily-wage-worker", "homemaker", "unemployed"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["DigiLocker", "Paperless Governance", "Driving License", "RC", "Aadhaar"],
...
const homeAffairsSchemes = [
    {
        ...
        tags: ["CAPF eAwas", "Paramilitary Housing", "CRPF", "BSF", "ITBP", "CISF"],
    ...
    },
    {
        ...
        tags: ["Ayushman CAPF", "Cashless Healthcare", "Troops Family", "PM-JAY Hospitals"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["salaried", "homemaker", "student"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["PMSS CAPF", "Martyrs Wards", "Scholarship", "₹3000 Monthly", "Degree Courses"],
        ...
        eligibility: {
            ...
            maxAge: 25,
            gender: ["male", "female", "transgender"],
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Victim Compensation", "Terrorism Relief", "Maoist Violence", "Ex-Gratia"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["farmer", "daily-wage-worker", "unemployed", "salaried", "homemaker"]
        },
    ...
    },
    {
        ...
        tags: ["MPF", "Police Modernization", "CCTV", "Forensic Labs", "Night Vision"],
    ...
    },
    {
        ...
        type: "central",
        category: "Public Safety, Law & Justice",
        tags: ["CCTNS", "Online FIR", "Police Verification", "Tenant Verification", "Citizen Services"],
    ...
    },
    {
        ...
        type: "central",
        category: "Public Safety, Law & Justice",
        tags: ["Cyber Crime", "1930 Helpline", "Financial Fraud", "Online Harassment", "Freeze Account"],
    ...
    },
    {
        ...
        type: "central",
        category: "Public Safety, Law & Justice",
        tags: ["Dial 112", "Emergency Police", "Ambulance", "Fire", "Women Safety SOS"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "salaried", "self-employed", "unemployed", "homemaker", "farmer", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Transport & Infrastructure",
        tags: ["Vibrant Villages", "Border Security", "Homestays", "Solar Power", "Eco-Tourism"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "st", "sc", "obc"],
            occupation: ["farmer", "self-employed", "homemaker"]
        },
        applyLink: "https://mha.gov.in/",
        baseMatchScore: 84
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["NDRF", "Disaster Relief", "Ex-Gratia", "Crop Loss Relief", "House Damage"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Aapda Mitra", "Disaster Volunteers", "Flood Rescue", "Life Jacket Kit", "First Aid"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Police Martyrs", "Ex-Gratia 15-25 Lakh", "Children Education", "Next of Kin"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["homemaker", "student", "salaried"]
        },
        applyLink: "https://mha.gov.in/",
        baseMatchScore: 88
    }
...
const youthAffairsSchemes = [
    {
        ...
        type: "central",
        category: "Sports & Culture",
        tags: ["Khelo India", "Athletes Scholarship", "5 Lakh Annual", "Sports Academy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Sports & Culture",
        tags: ["TOPS", "Olympic Athletes", "Foreign Coaches", "Out of Pocket Allowance"],
    ...
    },
    {
        ...
        type: "central",
        category: "Sports & Culture",
        tags: ["TOPS Junior", "Young Talents", "Monthly 25000", "Sports Science"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["NYC Volunteers", "Monthly Honorarium", "NYKS", "Youth Leadership"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["NSS", "Community Service", "Republic Day Camp", "College Volunteers"],
    ...
    },
    {
        ...
        type: "central",
        category: "Sports & Culture",
        tags: ["NYKS", "Youth Club", "Sports Kit", "Block Competitions", "Rural Youth"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "farmer", "unemployed", "self-employed"]
        },
        applyLink: "https://nyks.nic.in/",
        baseMatchScore: 86
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["RYSK", "Youth Empowerment", "Scouts & Guides", "Adventure Camps"],
    ...
    },
    {
        ...
        type: "central",
        category: "Sports & Culture",
        tags: ["NSDF", "Elite Sports", "Injury Rehabilitation", "Medical Grant"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Sports Science", "Fellowship", "Coach Training", "Overseas Specialization"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["National Youth Award", "Cash Prize 1 Lakh", "Gold Medal", "Youth Hero"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "self-employed", "salaried", "unemployed"]
        },
        applyLink: "https://awards.gov.in/",
        baseMatchScore: 85
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["Fit India", "Fitness Certificate", "Fit India School", "Daily Physical Activity"],
    ...
    },
    {
        ...
        type: "central",
        category: "Sports & Culture",
        tags: ["NSFs", "National Camps", "Foreign Coaches", "International Competitions"],
...
const defenceSchemes = [
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Agnipath", "Agniveer", "Army", "Navy", "Air Force", "Seva Nidhi ₹11.71 Lakh"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["iDEX", "Defence Startups", "SPARK Grant", "₹1.5 Crore", "Make in India"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["iDEX Prime", "Defence Tech", "₹10 Crore Grant", "Procurement Order"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["TDF DRDO", "Indigenous Defence", "₹50 Crore Grant", "Industry R&D"],
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["ECHS", "Veterans Healthcare", "Cashless OPD/IPD", "Polyclinics"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "homemaker", "salaried", "student"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["PMSS KSB", "Veterans Children", "Scholarship", "₹36000 Yearly", "Professional Degrees"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["RMEWF", "Penury Grant", "Daughters Marriage", "Disabled Children"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["OROP", "Equal Pension", "Veterans Arrears", "Defense Pension"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "homemaker", "salaried"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Banking, Financial Services & Insurance",
        tags: ["SPARSH", "Defence Pension", "Digital Life Certificate", "Direct Credit"],
    ...
    },
    {
        ...
        type: "central",
        category: "Housing & Shelter",
        tags: ["AWHO", "Defence Housing", "No Profit No Loss", "Gated Communities"],
...
const outContent = `// Batch of schemes for:
// - MSME: ${msmeSchemes.length} schemes
// - Agriculture and Farmers Welfare: ${agriSchemes.length} schemes
// - Textiles: ${textilesSchemes.length} schemes
// - Culture: ${cultureSchemes.length} schemes
// - Electronics and Information Technology: ${meitySchemes.length} schemes
// - Home Affairs: ${homeAffairsSchemes.length} schemes
// - Youth Affairs & Sports: ${youthAffairsSchemes.length} schemes
// - Defence: ${defenceSchemes.length} schemes
// Total = ${middleMinistriesSchemes.length} schemes

const middleMinistriesSchemes = ${JSON.stringify(middleMinistriesSchemes, null, 4)};

module.exports = { middleMinistriesSchemes };
`;

fs.writeFileSync('backend/data/batches/batch_middle_ministries.js', outContent, 'utf8');
console.log('Successfully wrote batch_middle_ministries.js with', middleMinistriesSchemes.length, 'schemes');
console.log('MSME:', msmeSchemes.length, '(expected 22)');
console.log('Agriculture:', agriSchemes.length, '(expected 18)');
console.log('Textiles:', textilesSchemes.length, '(expected 17)');
console.log('Culture:', cultureSchemes.length, '(expected 13)');
console.log('Electronics & IT:', meitySchemes.length, '(expected 13)');
console.log('Home Affairs:', homeAffairsSchemes.length, '(expected 12)');
console.log('Youth Affairs:', youthAffairsSchemes.length, '(expected 12)');
console.log('Defence:', defenceSchemes.length, '(expected 10)');
