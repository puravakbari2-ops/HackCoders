...
const socialJusticeSchemes = [
    {
        ...
        tags: ["NOS-PwD", "Study Abroad", "Disability Scholarship", "Master's & PhD"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["SHRESHTA", "SC Students", "CBSE Schools", "Full Scholarship", "Residential"],
    ...
    },
    {
        ...
        tags: ["PM DAKSH", "Skill Training", "SC/OBC/EBC", "Stipend", "Job Placement"],
        ...
        eligibility: {
            ...
            category: ["sc", "obc"],
            occupation: ["unemployed", "daily-wage-worker", "self-employed"]
        },
    ...
    },
    {
        ...
        tags: ["SMILE", "Transgender", "Gender Affirmation", "Scholarship", "Skill Training"],
        ...
        eligibility: {
            ...
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "self-employed", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["SMILE", "Beggary Rehabilitation", "Shelter", "Skill Training", "Healthcare"],
    ...
    },
    {
        ...
        tags: ["NMBA", "De-Addiction", "Youth Rehabilitation", "Counselling"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "self-employed", "salaried", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Senior Citizens", "Old Age Home", "Shelter", "Nutrition", "Geriatric Care"],
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["Vayoshri", "Senior Citizens", "Hearing Aid", "Wheelchair", "Spectacles"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "homemaker", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Elderline", "14567", "Senior Citizens", "Rescue", "Legal Aid"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "homemaker", "salaried", "self-employed"]
        },
        applyLink: "https://socialjustice.gov.in/",
        baseMatchScore: 87
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["NAPDDR", "Substance Abuse", "Rehabilitation", "Awareness"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "student", "daily-wage-worker"]
        },
        applyLink: "https://socialjustice.gov.in/",
        baseMatchScore: 81
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["SRMS", "Manual Scavenger", "Rehabilitation", "One-Time Cash", "Capital Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["NAMASTE", "Sanitation Workers", "Sewer Cleaning", "PPE Kits", "Machinery Loan"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["daily-wage-worker", "self-employed"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["ADIP", "Divyangjan", "Wheelchair", "Tricycle", "Cochlear Implant", "ALIMCO"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "daily-wage-worker", "self-employed", "homemaker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Sugamya Bharat", "Barrier Free", "Accessibility", "Ramps & Lifts"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "salaried", "self-employed", "homemaker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["UDID", "Swavlamban", "Disability Certificate", "Concessions"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "daily-wage-worker", "self-employed", "salaried", "homemaker"]
        },
    ...
    },
    {
        ...
        tags: ["NHFDC", "PwD Loan", "Self Employment", "Low Interest", "Divyangjan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["NOS", "Study Abroad", "SC Scholarship", "Master's & PhD", "Full Funding"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Top Class SC", "IIT/IIM Fee Waiver", "Laptop Grant", "Books Allowance"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Pre-Matric", "SC Scholarship", "Class 9-10", "DBT", "NSP"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Post-Matric", "PMS-SC", "College Fee", "Maintenance Allowance", "DBT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["BJRCY", "SC Hostels", "Girls Hostel", "Free Lodging"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["VCF-SC", "Venture Capital", "SC Entrepreneurs", "Equity Funding", "IFCI"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["CEGSSC", "Loan Guarantee", "Collateral Free", "SC Business"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Interest Subsidy", "Education Loan", "OBC", "EBC", "Overseas Studies"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["YASASVI", "Pre-Matric", "OBC", "EBC", "DNT", "School Scholarship"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["YASASVI", "Post-Matric", "OBC Scholarship", "College Fee", "Maintenance"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["NFOBC", "UGC NET", "PhD Fellowship", "OBC Research"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["NFPwD", "Divyangjan", "PhD Stipend", "UGC", "Research"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Top Class OBC", "Premier Institutes", "IIT/NIT", "Fee Reimbursement"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["SEED", "DNT", "Health Insurance", "Housing", "Free Coaching"],
        ...
        eligibility: {
            ...
            occupation: ["daily-wage-worker", "farmer", "unemployed", "self-employed"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Free Coaching", "UPSC", "SSC", "Banking", "NEET/JEE", "Stipend"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NSKFDC", "Sanitation Workers", "Safai Karamchari", "Business Loan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Mahila Samridhi", "Women Scavengers", "Micro Loan", "Low Interest"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Swachhta Udyami", "Suction Machines", "Entrepreneurship", "Sanitation"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NBCFDC", "New Swarnima", "OBC Women", "Microcredit", "Empowerment"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["obc"],
            occupation: ["self-employed", "homemaker", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Education Loan", "NBCFDC", "OBC Students", "Low Interest"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Shilp Sampada", "OBC Artisans", "Crafts Loan", "Tools Grant"],
    ...
    },
    {
        ...
        tags: ["Mahila Kisan", "OBC Women", "Agri Loan", "Dairy", "Poultry"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NSFDC", "SC Loan", "Term Loan", "Self Employment", "Low Interest"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NSFDC", "SC Women", "Micro Finance", "SHG Loan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["MCF", "Micro Credit", "SC SHG", "Working Capital"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Laghu Vyavasay", "Small Business", "SC Entrepreneurs", "Working Capital"],
    ...
    },
    {
        ...
        tags: ["Dhosti Scheme", "Commercial Vehicle", "SC Drivers", "Auto/Taxi Loan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["SIPDA", "Accessible Infrastructure", "Government Offices", "Divyangjan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["DDRS", "Special Schools", "Rehabilitation", "NGO Grant", "Therapy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["National Institutes", "Free Physiotherapy", "Speech Therapy", "DEPwD"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "daily-wage-worker", "homemaker", "self-employed"]
        },
        applyLink: "https://depwd.gov.in/",
        baseMatchScore: 87
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["CRC", "Rehabilitation", "Skill Training", "Prosthetics", "Divyangjan"],
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["DDRC", "District Centres", "Prosthetics", "Divyang Aid"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["student", "unemployed", "daily-wage-worker", "farmer", "homemaker"]
        },
        applyLink: "https://depwd.gov.in/",
        baseMatchScore: 84
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["Niramaya", "Health Insurance", "Autism", "Cerebral Palsy", "National Trust"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Samarth", "Respite Care", "Severe Disability", "Relief for Parents"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Gharaunda", "Group Home", "Lifelong Care", "National Trust"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Vikas Day Care", "Day Care", "Therapy", "Intellectual Disability"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["Sahyogi", "Caregiver Training", "Disability Care", "Stipend"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Prerna", "Marketing Grant", "PwD Artisans", "Exhibitions"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Sambhav", "Assistive Tech", "Demo Centre", "Aids"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Gyan Prabha", "Vocational Scholarship", "National Trust", "Divyang"],
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["Disha", "Early Intervention", "Infants", "Therapy", "School Readiness"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["PM-AJAY", "Adarsh Gram", "Model Village", "SC Majority Village"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["sc", "general", "obc"],
            occupation: ["farmer", "daily-wage-worker", "self-employed", "homemaker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["PM-AJAY", "Livelihood Grant", "SC Families", "Income Generation"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Garima Greh", "Shelter Home", "Transgender", "Free Food", "Medical Care"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "daily-wage-worker"]
        },
        applyLink: "https://transgender.dosje.gov.in/",
        baseMatchScore: 88
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Transgender Certificate", "Identity Card", "Self Perceived Gender", "Online"],
    ...
    },
    {
        ...
        type: "central",
        category: "Skills & Employment",
        tags: ["SACRED", "Senior Jobs", "Re-employment", "Consulting", "Retirees"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SAGE", "Silver Economy", "Elder Care Startups", "Equity Grant"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["Hazardous Occupations", "Waste Pickers", "Tanners", "Children Scholarship"],
    ...
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["Dr Ambedkar Medical", "Heart Surgery", "Kidney Transplant", "Cancer Care", "SC/ST"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l"],
            category: ["sc", "st"],
            occupation: ["daily-wage-worker", "farmer", "unemployed", "homemaker"]
        },
        applyLink: "https://socialjustice.gov.in/",
        baseMatchScore: 89
    },
    {
        ...
        tags: ["PoA Act", "Atrocity Relief", "Legal Aid", "SC/ST Protection"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["sc", "st"],
            occupation: ["daily-wage-worker", "farmer", "unemployed", "salaried", "self-employed", "homemaker"]
        },
        applyLink: "https://socialjustice.gov.in/",
        baseMatchScore: 91
    },
    {
        ...
        type: "central",
        category: "Health & Wellness",
        tags: ["IRCA", "Inpatient Deaddiction", "Detoxification", "Mental Health"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["unemployed", "daily-wage-worker", "salaried", "self-employed"]
        },
        applyLink: "https://socialjustice.gov.in/",
        baseMatchScore: 84
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["National Award", "Divyangjan Role Model", "Cash Prize", "President of India"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["salaried", "self-employed", "student", "unemployed"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Vayoshreshtha", "Senior Citizen Honour", "Centenarian Award", "Cash Prize"],
    ...
    },
    {
        ...
        type: "central",
        category: "Social Welfare & Empowerment",
        tags: ["Inter-Caste Marriage", "Incentive", "Social Integration", "DBT"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l"],
            category: ["sc", "general", "obc"],
            occupation: ["salaried", "self-employed", "unemployed", "farmer"]
        },
        applyLink: "https://socialjustice.gov.in/",
        baseMatchScore: 82
    }
...
// Ministry of Commerce and Industry (46 schemes)
const commerceAndIndustrySchemes = [
    {
        id: "comm-sisfs",
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SISFS", "Seed Fund", "Startup India", "Proof of Concept", "Incubators"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["FFS", "SIDBI", "Venture Capital", "Alternative Investment Funds", "DPIIT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["CGSS", "Credit Guarantee", "Collateral Free Loan", "Venture Debt"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI", "Electronics", "Mobile Phones", "Make in India", "Incentive"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI Pharma", "APIs", "Drug Manufacturing", "KSMs", "Incentive"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI Telecom", "5G Equipment", "Routers", "Switches", "Make in India"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI White Goods", "Air Conditioners", "LED Lights", "Component Manufacturing"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI Auto", "Electric Vehicles", "Advanced Automotive Tech", "Hydrogen Fuel"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["ACC Battery", "Giga Factories", "Lithium Ion", "Energy Storage"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI MedTech", "Medical Devices", "MRI/CT Scanners", "Dialysis", "Incentive"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI Steel", "Specialty Steel", "Electrical Steel", "Alloy Steel"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PLI Drones", "UAV", "Drone Components", "Flight Controllers", "Incentive"],
    ...
    },
    {
        ...
        type: "central",
        category: "Transport & Infrastructure",
        tags: ["GatiShakti", "Logistics", "Multi-Modal", "Freight Corridors", "GIS"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NICDC", "Smart Cities", "Industrial Parks", "Plug & Play Factory"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["ODOP", "Artisans", "District Exports", "Geographical Indication", "E-Commerce"],
        ...
        eligibility: {
            ...
            income: ["below-1l", "1l-2.5l", "2.5l-5l", "5l-8l", "8l-10l", "above-10l"],
            category: ["general", "sc", "st", "obc"],
            occupation: ["self-employed", "farmer", "daily-wage-worker"]
        },
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["IPRS", "Industrial Parks", "Infrastructure Rating", "SEZ"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["NSWS", "Single Window", "Ease of Doing Business", "Licenses"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Invest India", "FDI Facilitation", "Joint Ventures", "Handholding"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Make in India", "Manufacturing", "Export Promotion", "Champion Sectors"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Investment Promotion", "Roadshows", "FDI Growth", "DPIIT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Leather Cluster", "Footwear", "IFLDP", "Infrastructure Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Sustainable Leather", "CETP", "Zero Liquid Discharge", "Green Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Brand Promotion", "Footwear Exports", "Global Marketing", "Leather"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["PMG", "Fast Track Clearance", "Mega Projects", "Inter-Ministerial"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["MAI", "Exporters", "Overseas Fairs", "Stall Subsidy", "Buyer Seller Meet"],
    ...
    },
    {
        ...
        type: "central",
        category: "Agriculture, Rural & Environment",
        tags: ["TMA", "Agri Exports", "Freight Subsidy", "Air Freight", "Shipping"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Interest Subvention", "Export Credit", "Working Capital", "RBI"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["EPCG", "Duty Free Machinery", "Customs Duty Waiver", "Capital Goods"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Advance Authorisation", "Raw Materials", "Customs Exemption", "DGFT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["DFIA", "Transferable Duty Exemption", "Import Insumos", "DGFT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["RoDTEP", "Tax Rebate", "Export Incentive", "Transferable Scrips"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["RoSCTL", "Textiles", "Garment Exports", "Duty Scrips", "Customs Rebate"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Status Holder", "Star Export House", "Fast Track Customs", "DGFT"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SEZ", "Tax Exemption", "Zero Duty Import", "Export Zone"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["EOU", "Duty Free Procurement", "100% Export", "Manufacturing"],
    ...
    },
    {
        ...
        tags: ["EHTP", "Hardware Manufacturing", "Duty Free Import", "Electronics Export"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["STPI", "IT Exports", "Software Tech Park", "Incubation", "High Speed Bandwidth"],
    ...
    },
    {
        ...
        type: "central",
        category: "Transport & Infrastructure",
        tags: ["TIES", "Cold Chain", "Testing Labs", "Dry Ports", "Export Infra"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SEIS", "Service Exports", "Tourism", "Consulting", "Duty Credit Scrips"],
    ...
    },
    {
        ...
        type: "central",
        category: "Science, IT & Communications",
        tags: ["PPH", "Fast Track Patent", "IP India", "International Patents"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["SIPP", "Free Facilitators", "Patent Fee Concession", "Trademark 50%"],
    ...
    },
    {
        ...
        type: "central",
        category: "Education & Learning",
        tags: ["NIPAM", "IP Awareness", "Patent Education", "Schools & Colleges"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["IBP", "B2B Export", "FIEO", "Global Buyers", "MSME Showcase"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["GI Tag", "Traditional Crafts", "Intellectual Property", "Authenticity Logo"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["ZED Certification", "Quality Standards", "Eco Friendly", "MSME Subsidy"],
    ...
    },
    {
        ...
        type: "central",
        category: "Business & Entrepreneurship",
        tags: ["Startup Awards", "Cash Prize", "DPIIT", "Investor Access", "Mentorship"],
...
const socialAndCommerceSchemes = [...socialJusticeSchemes, ...commerceAndIndustrySchemes];

const outContent = `// Batch of schemes for:
// - Ministry of Social Justice and Empowerment: ${socialJusticeSchemes.length} schemes
// - Ministry of Commerce and Industry: ${commerceAndIndustrySchemes.length} schemes
// Total = ${socialAndCommerceSchemes.length} schemes

const socialAndCommerceSchemes = ${JSON.stringify(socialAndCommerceSchemes, null, 4)};

module.exports = { socialAndCommerceSchemes };
`;

fs.writeFileSync('backend/data/batches/batch_social_commerce.js', outContent, 'utf8');
console.log('Successfully wrote batch_social_commerce.js with', socialAndCommerceSchemes.length, 'schemes');
console.log('Social Justice:', socialJusticeSchemes.length, '(expected 70)');
console.log('Commerce & Industry:', commerceAndIndustrySchemes.length, '(expected 46)');
